...
Official authorities and reporting correspondents on the ground continue to monitor developments closely as further communiqués and statements are anticipated in the coming hours.`}resolveContextualNewsImage(e,t,a,s,i=0){if(e&&!e.includes("1x1")&&!e.includes("pixel")&&!e.includes("favicon"))return e;const n=`${t} ${a}`.toLowerCase();return s.region==="india"||s.isPolitics||n.includes("india")||n.includes("delhi")?n.includes("supreme court")||n.includes("high court")||n.includes("judge")||n.includes("judiciary")||n.includes("verdict")||n.includes("bench")||n.includes("bail")||n.includes("cbi")||n.includes("ed")?x.judiciary_law[0]:n.includes("isro")||n.includes("space")||n.includes("satellite")||n.includes("chandrayaan")||n.includes("drdo")||n.includes("missile")?x.defense_isro[i%x.defense_isro.length]:n.includes("rupee")||n.includes("rbi")||n.includes("reserve bank")||n.includes("bank")||n.includes("sensex")||n.includes("nifty")||n.includes("gdp")||n.includes("inflation")||n.includes("finance minister")?x.economy_rbi[i%x.economy_rbi.length]:n.includes("solar")||n.includes("renewable")||n.includes("power")||n.includes("green energy")?x.clean_energy[0]:n.includes("semiconductor")||n.includes("chip")||n.includes("fab")||n.includes("hardware")?x.technology[0]:x.parliament_governance[i%x.parliament_governance.length]:q[i%q.length]}isPoliticalArticle(e,t){const a=`${e} ${t}`.toLowerCase();return["parliament","lok sabha","rajya sabha","bjp","congress","election","elections","minister","cabinet","supreme court","chief minister","prime minister","modi","rahul gandhi","governor","mla","mp","assembly","ordinance","bill","judiciary","constitution","poll","party","yogi","kejriwal","shah","niti aayog","electoral","high court"].some(i=>a.includes(i))}parseDateSafe(e){if(!e)return new Date().toISOString();const t=new Date(e);return isNaN(t.getTime())?new Date().toISOString():t.toISOString()}stripHtml(e){if(!e)return"";const t=document.createElement("DIV");return t.innerHTML=e,t.textContent||t.innerText||""}extractCleanSnippet(e){const t=this.stripHtml(e);if(!t)return"Read the complete verified story on the original publisher broadcast.";const a=t.replace(/\s+/g," ").trim();return a.length>260?a.substring(0,257)+"...":a}extractImageFromXml(e,t){const a=Array.from(e.querySelectorAll("enclosure"));for(const n of a){const o=n.getAttribute("type")||"",r=n.getAttribute("url");if(r&&(o.startsWith("image")||r.match(/\.(jpeg|jpg|png|webp)/i)))return r}const s=Array.from(e.getElementsByTagNameNS("*","content")).concat(Array.from(e.getElementsByTagNameNS("*","thumbnail")));for(const n of s){const o=n.getAttribute("url");if(o&&!o.includes("1x1")&&!o.includes("analytics")&&!o.includes("logo"))return o}const i=e.querySelector("storyimage, thumb, image > url, fullimage");if(i&&i.textContent){const n=i.textContent.trim();if(n.startsWith("http"))return n}return this.extractImageFromHtml(t)}extractImageFromHtml(e){if(e){const t=e.matchAll(/<img[^>]+(?:src|data-src|data-original)=["']([^"']+)["']/gi);for(const a of t){const s=a[1];if(s&&!s.includes("feedburner")&&!s.includes("analytics")&&!s.includes("1x1")&&!s.includes("pixel")&&!s.includes("badge")&&!s.includes("button")&&!s.includes("icon"))return s}}return null}generateKeyPoints(e,t,a){return[`Primary Development: ${e}`,`Core Briefing: ${t.length>30?t.substring(0,140)+"...":"Verified wire bulletin from "+a.name+"."}`,`Verified Media Wire: Real-time update monitored on ${a.name} editorial network.`]}async fetchArticleOgImage(e){if(!e||!e.startsWith("http"))return null;const t=p.getArticleImage(e);if(t)return t;try{const a=`/api/proxy-rss?url=${encodeURIComponent(e)}&extract=image`,s=await fetch(a,{signal:AbortSignal.timeout(4e3)});if(s.ok){const i=await s.json();if(i&&i.success&&i.image)return p.setArticleImage(e,i.image),i.image}}catch{}try{const a=`https://api.allorigins.win/get?url=${encodeURIComponent(e)}`,s=await fetch(a,{signal:AbortSignal.timeout(4e3)});if(s.ok){const n=(await s.json()).contents||"",o=n.match(/<meta[^>]+(?:property|name)=["'](?:og:image|og:image:url|twitter:image|twitter:image:src)["'][^>]+content=["']([^"']+)["']/i)||n.match(/<meta[^>]+content=["']([^"']+)["'][^>]+(?:property|name)=["'](?:og:image|og:image:url|twitter:image|twitter:image:src)["']/i);if(o&&o[1]){let r=o[1].trim().replace(/&amp;/g,"&");if(r.startsWith("//")&&(r="https:"+r),r.startsWith("http"))return p.setArticleImage(e,r),r}}}catch{}return null}async enrichSourceArticlesWithOgImages(e){if(!e||e.length===0)return e;const t=e.filter(a=>a.hasPlaceholderImage&&a.link);return t.length===0||await Promise.allSettled(t.slice(0,10).map(async a=>{try{const s=await this.fetchArticleOgImage(a.link);s&&(a.image=s,a.hasPlaceholderImage=!1)}catch{}})),e}async enrichArticlesWithImages(e,t){if(!e||e.length===0)return;const a=e.filter(i=>i.hasPlaceholderImage&&i.link);if(a.length===0)return;const s=3;for(let i=0;i<a.length;i+=s){const n=a.slice(i,i+s);await Promise.allSettled(n.map(async o=>{try{const r=await this.fetchArticleOgImage(o.link);r&&r!==o.image&&(o.image=r,o.hasPlaceholderImage=!1,typeof t=="function"&&t(o))}catch{}}))}}}const H=new Y;class Q{constructor(){this.synth=window.speechSynthesis,this.currentUtterance=null,this.isPlaying=!1,this.isPaused=!1,this.currentArticleId=null,this.callbacks=[],this.voices=[],this.synth&&(this.loadVoices(),speechSynthesis.onvoiceschanged!==void 0&&(speechSynthesis.onvoiceschanged=()=>this.loadVoices()))}loadVoices(){this.voices=this.synth.getVoices()}getBestVoice(){return this.voices.length||this.loadVoices(),this.voices.find(t=>t.lang.startsWith("en")&&(t.name.includes("Natural")||t.name.includes("Google")||t.name.includes("Premium")))||this.voices.find(t=>t.lang.startsWith("en"))||this.voices[0]}speakArticle(e,t){if(!this.synth){console.warn("Speech synthesis not supported in this browser.");return}if(this.isPlaying&&this.currentArticleId===e.id){this.isPaused?this.resume():this.pause();return}this.stop();const a=e.title?e.title.replace(/<[^>]*>?/gm,""):"",s=e.snippet?e.snippet.replace(/<[^>]*>?/gm,""):"",i=e.content?e.content.replace(/<[^>]*>?/gm,""):"",n=`Story from ${e.source}. Headline: ${a}. Summary: ${s||i}`;this.currentUtterance=new SpeechSynthesisUtterance(n),this.currentUtterance.voice=this.getBestVoice(),this.currentUtterance.rate=1,this.currentUtterance.pitch=1,this.currentArticleId=e.id,this.isPlaying=!0,this.isPaused=!1,this.currentUtterance.onstart=()=>{this.notifyStateChange("playing",e)},this.currentUtterance.onend=()=>{this.isPlaying=!1,this.isPaused=!1,this.currentArticleId=null,this.notifyStateChange("ended",e),t&&t()},this.currentUtterance.onerror=o=>{console.warn("Speech synthesis error",o),this.isPlaying=!1,this.isPaused=!1,this.currentArticleId=null,this.notifyStateChange("ended",e)},this.synth.speak(this.currentUtterance)}pause(){this.synth&&this.isPlaying&&!this.isPaused&&(this.synth.pause(),this.isPaused=!0,this.notifyStateChange("paused"))}resume(){this.synth&&this.isPlaying&&this.isPaused&&(this.synth.resume(),this.isPaused=!1,this.notifyStateChange("playing"))}stop(){this.synth&&(this.synth.cancel(),this.isPlaying=!1,this.isPaused=!1,this.currentArticleId=null,this.notifyStateChange("stopped"))}subscribe(e){return this.callbacks.push(e),()=>{this.callbacks=this.callbacks.filter(t=>t!==e)}}notifyStateChange(e,t=null){this.callbacks.forEach(a=>a({state:e,article:t,articleId:this.currentArticleId,isPlaying:this.isPlaying,isPaused:this.isPaused}))}}const P=new Q,X="modulepreload",Z=function(f){return"/"+f},_={},C=function(e,t,a){let s=Promise.resolve();if(t&&t.length>0){let n=function(d){return Promise.all(d.map(c=>Promise.resolve(c).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),r=(o==null?void 0:o.nonce)||(o==null?void 0:o.getAttribute("nonce"));s=n(t.map(d=>{if(d=Z(d),d in _)return;_[d]=!0;const c=d.endsWith(".css"),u=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${u}`))return;const h=document.createElement("link");if(h.rel=c?"stylesheet":X,c||(h.as="script"),h.crossOrigin="",h.href=d,r&&h.setAttribute("nonce",r),document.head.appendChild(h),c)return new Promise((g,y)=>{h.addEventListener("load",g),h.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${d}`)))})}))}function i(n){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=n,window.dispatchEvent(o),!o.defaultPrevented)throw n}return s.then(n=>{for(const o of n||[])o.status==="rejected"&&i(o.reason);return e().catch(i)})},ee="essential-guard-367s8",te="1:172663244757:web:290be1a9685d1714241f5c",ie="AIzaSyDF0XeoXy3i7Q-J-LunBUc6iAtZ1cZHVaU",se="essential-guard-367s8.firebaseapp.com",ae="essential-guard-367s8.firebasestorage.app",ne="172663244757",v={projectId:ee,appId:te,apiKey:ie,authDomain:se,storageBucket:ae,messagingSenderId:ne},T={apiKey:v==null?void 0:v.apiKey,authDomain:v==null?void 0:v.authDomain,projectId:v==null?void 0:v.projectId,storageBucket:v==null?void 0:v.storageBucket,messagingSenderId:v==null?void 0:v.messagingSenderId,appId:v==null?void 0:v.appId},I={CURRENT_USER:"wgo_auth_user_v1",REGISTERED_USERS:"wgo_registered_users_v1",BREAKING_ALERT:"wgo_breaking_alert_v1"},W=1440*60*1e3;function D(f){try{return btoa(encodeURIComponent(f+"_wgo_salt_2026"))}catch{return f}}function F(f,e){return D(f)===e}const A={e:"dhananjaysaini2006@gmail.com",h:D("242622")};class oe{constructor(){this.currentUser=null,this.authListeners=[],this.isFirebaseLive=!1,this.firebaseApp=null,this.firebaseAuth=null,this.firebaseStorage=null,this.init()}async init(){this.loadSavedSession(),this.ensureAdminExists();try{if(T.apiKey&&!T.apiKey.includes("Placeholder")){const{initializeApp:e,getApps:t,getApp:a}=await C(async()=>{const{initializeApp:i,getApps:n,getApp:o}=await import("./index.esm-DodTF3pm.js");return{initializeApp:i,getApps:n,getApp:o}},__vite__mapDeps([0,1])),{getAuth:s}=await C(async()=>{const{getAuth:i}=await import("./index.esm-BlLn1iMx.js");return{getAuth:i}},__vite__mapDeps([2,1]));this.firebaseApp=t().length?a():e(T),this.firebaseAuth=s(this.firebaseApp),this.isFirebaseLive=!0,console.info("Connected to live Firebase Cloud project.")}}catch(e){console.info("Using local Firebase Authentication adapter.",e)}}async getFirebaseStorage(){if(this.firebaseStorage)return this.firebaseStorage;const{initializeApp:e,getApps:t,getApp:a}=await C(async()=>{const{initializeApp:i,getApps:n,getApp:o}=await import("./index.esm-DodTF3pm.js");return{initializeApp:i,getApps:n,getApp:o}},__vite__mapDeps([0,1])),{getStorage:s}=await C(async()=>{const{getStorage:i}=await import("./index.esm-CPKYH5eW.js");return{getStorage:i}},__vite__mapDeps([3,1]));return this.firebaseApp||(this.firebaseApp=t().length?a():e(T)),this.firebaseStorage=s(this.firebaseApp),this.firebaseStorage}async uploadArticleImage(e,t){const a=await this.getFirebaseStorage(),{ref:s,uploadBytesResumable:i,getDownloadURL:n}=await C(async()=>{const{ref:h,uploadBytesResumable:g,getDownloadURL:y}=await import("./index.esm-CPKYH5eW.js");return{ref:h,uploadBytesResumable:g,getDownloadURL:y}},__vite__mapDeps([3,1])),o=(e.name||"image.jpg").replace(/[^a-zA-Z0-9._-]/g,"_"),r=`article-images/${Date.now()}-${o}`,d=s(a,r),c={contentType:e.type||"image/jpeg",customMetadata:{originalName:e.name,uploadedAt:new Date().toISOString()}},u=i(d,e,c);return new Promise((h,g)=>{u.on("state_changed",y=>{if(y.totalBytes>0){const E=Math.round(y.bytesTransferred/y.totalBytes*100);typeof t=="function"&&t(E)}},y=>{console.error("[Firebase Storage] Upload error:",y),g(y)},async()=>{try{const y=await n(u.snapshot.ref);h(y)}catch(y){g(y)}})})}loadSavedSession(){try{const e=localStorage.getItem(I.CURRENT_USER);e&&(this.currentUser=JSON.parse(e))}catch{this.currentUser=null}}ensureAdminExists(){const e=this.getAllUsers();if(!e.some(a=>a.email.toLowerCase()===A.e.toLowerCase())){e.unshift({uid:"admin-ds-wgo",email:A.e,displayName:"Dhananjay Saini",role:"admin",passwordHash:A.h,createdAt:"2026-09-02T00:00:00.000Z"});try{localStorage.setItem(I.REGISTERED_USERS,JSON.stringify(e))}catch{}}}getAllUsers(){try{const e=localStorage.getItem(I.REGISTERED_USERS);return e?JSON.parse(e):[]}catch{return[]}}getCurrentUser(){return this.currentUser}isAdmin(){return this.currentUser&&(this.currentUser.role==="admin"||this.currentUser.email&&this.currentUser.email.toLowerCase()===A.e.toLowerCase())}onAuthStateChanged(e){return this.authListeners.push(e),e(this.currentUser),()=>{this.authListeners=this.authListeners.filter(t=>t!==e)}}notifyAuthChanged(){this.authListeners.forEach(e=>{try{e(this.currentUser)}catch(t){console.error("Error in auth listener:",t)}})}async signIn(e,t){const a=(e||"").trim().toLowerCase(),s=(t||"").trim();if(!a||!s)throw new Error("Please provide both email and password.");if(!a.includes("@"))throw new Error("Please enter a valid email address.");if(a===A.e.toLowerCase()){if(F(s,A.h))return this.currentUser={uid:"admin-ds-wgo",email:A.e,displayName:"Dhananjay Saini",role:"admin",photoURL:null},localStorage.setItem(I.CURRENT_USER,JSON.stringify(this.currentUser)),this.notifyAuthChanged(),this.currentUser;throw new Error("Incorrect password. Please try again.")}const n=this.getAllUsers().find(r=>r.email.toLowerCase()===a);if(!n)throw new Error("No account found with this email. Please sign up first.");if(!(n.passwordHash?F(s,n.passwordHash):n.passwordHash===s))throw new Error("Invalid password. Please try again.");return this.currentUser={uid:n.uid,email:n.email,displayName:n.displayName,role:n.role||"reader",photoURL:n.photoURL||null},localStorage.setItem(I.CURRENT_USER,JSON.stringify(this.currentUser)),this.notifyAuthChanged(),this.currentUser}async signUp(e,t,a=""){const s=(e||"").trim().toLowerCase(),i=(t||"").trim(),n=(a||"").trim()||s.split("@")[0];if(!s||!i)throw new Error("Please provide email and password.");if(!s.includes("@"))throw new Error("Please enter a valid email address.");if(i.length<8)throw new Error("Password must be at least 8 characters long.");const o=this.getAllUsers();if(o.some(d=>d.email.toLowerCase()===s))throw new Error("An account with this email already exists. Please sign in.");const r={uid:"user-"+Date.now(),email:s,displayName:n,role:"reader",passwordHash:D(i),createdAt:new Date().toISOString()};o.push(r);try{localStorage.setItem(I.REGISTERED_USERS,JSON.stringify(o))}catch(d){console.warn("Failed to save user",d)}return this.currentUser={uid:r.uid,email:r.email,displayName:r.displayName,role:r.role,photoURL:null},localStorage.setItem(I.CURRENT_USER,JSON.stringify(this.currentUser)),this.notifyAuthChanged(),this.currentUser}async signOut(){this.currentUser=null,localStorage.removeItem(I.CURRENT_USER),this.notifyAuthChanged()}getBreakingAlert(){try{const e=localStorage.getItem(I.BREAKING_ALERT);if(!e)return null;const t=JSON.parse(e);return t.timestamp&&Date.now()-new Date(t.timestamp).getTime()>W?(localStorage.removeItem(I.BREAKING_ALERT),null):t}catch{return null}}setBreakingAlert(e,t="high"){if(!this.isAdmin())throw new Error("Unauthorized. Only Admins can broadcast alerts.");const a={id:"alert-"+Date.now(),text:e,urgency:t,timestamp:new Date().toISOString(),author:this.currentUser.displayName,expiresAt:new Date(Date.now()+W).toISOString()};return localStorage.setItem(I.BREAKING_ALERT,JSON.stringify(a)),a}clearBreakingAlert(){if(!this.isAdmin())throw new Error("Unauthorized.");localStorage.removeItem(I.BREAKING_ALERT)}}const w=new oe;class re{constructor(e,t,a,s,i,n,o){this.onRefreshCallback=e,this.onSearchCallback=t,this.onThemeToggleCallback=a,this.onIntervalChangeCallback=s,this.onPublishClickCallback=i,this.onAuthClickCallback=n,this.onAdminClickCallback=o,this.remainingSeconds=p.getRefreshInterval(),this.totalSeconds=this.remainingSeconds,this.countdownTimer=null,this.clockTimer=null}init(){this.renderHeader(),this.startLiveClock(),this.startCountdown(),this.attachEventListeners(),this.updateBookmarkBadge(),this.initMobileDrawer()}renderHeader(){const e=document.getElementById("top-utility-bar"),t=document.getElementById("main-header");e&&(e.innerHTML=`
      ...
      `+r.map(c=>`
        <button
          ...
          data-cat="${c.id}"
        >${c.label}</button>
      `).join(""),(d=i.querySelector("#btn-mobile-drawer-publish-cta"))==null||d.addEventListener("click",()=>{o(),this.onPublishClickCallback&&this.onPublishClickCallback()}),i.querySelectorAll(".mobile-drawer-cat-btn").forEach(c=>{c.addEventListener("click",()=>{const u=document.querySelector(`.cat-tab[data-category="${c.dataset.cat}"]`);u&&u.click(),i.querySelectorAll(".mobile-drawer-cat-btn").forEach(h=>h.classList.remove("active")),c.classList.add("active"),o(),window.scrollTo({top:0,behavior:"smooth"})})}))}startLiveClock(){const e=()=>{const t=new Date,a=document.getElementById("current-clock-time"),s=document.getElementById("current-clock-date");a&&(a.textContent=t.toLocaleTimeString("en-IN",{hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0})),s&&(s.textContent=t.toLocaleDateString("en-US",{weekday:"short",month:"short",day:"numeric",year:"numeric"}))};e(),this.clockTimer=setInterval(e,1e3)}startCountdown(){this.countdownTimer&&clearInterval(this.countdownTimer),this.totalSeconds=p.getRefreshInterval(),this.remainingSeconds=this.totalSeconds,this.nextRefreshTime=Date.now()+this.totalSeconds*1e3;const e=document.getElementById("countdown-circle-bar"),t=document.getElementById("countdown-text"),a=2*Math.PI*7;e&&(e.style.strokeDasharray=`${a}`);const s=()=>{const i=Date.now(),n=this.nextRefreshTime-i,o=Math.max(0,Math.ceil(n/1e3));this.remainingSeconds=o;const r=Math.floor(this.remainingSeconds/60),d=this.remainingSeconds%60;if(t&&(t.textContent=`${r.toString().padStart(2,"0")}:${d.toString().padStart(2,"0")}`),e){const c=Math.min(1,Math.max(0,this.remainingSeconds/this.totalSeconds)),u=a*(1-c);e.style.strokeDashoffset=`${u}`}o<=0&&(this.resetCountdown(),t&&(t.textContent="Syncing..."),this.onRefreshCallback&&this.onRefreshCallback(!0))};s(),this.countdownTimer=setInterval(s,1e3),this.visibilityListenerAttached||(this.visibilityListenerAttached=!0,document.addEventListener("visibilitychange",()=>{document.visibilityState==="visible"&&s()}))}resetCountdown(){this.totalSeconds=p.getRefreshInterval(),this.remainingSeconds=this.totalSeconds,this.nextRefreshTime=Date.now()+this.totalSeconds*1e3}updateLastSyncTime(e=new Date){const t=document.getElementById("last-sync-time");if(t){const a=e.toLocaleTimeString("en-IN",{hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0});t.textContent=`Synced: ${a}`}}updateBookmarkBadge(){const e=document.getElementById("header-bookmark-badge"),t=p.getBookmarks().length;e&&(e.textContent=t,e.style.display=t>0?"flex":"none")}updateUserAuthState(e){var u,h,g,y,E;const t=document.getElementById("header-auth-container"),a=document.getElementById("topbar-auth-pill"),s=document.getElementById("btn-open-publish-modal"),i=e&&(e.role==="admin"||e.email&&e.email.toLowerCase()==="dhananjaysaini2006@gmail.com");s&&(i?(s.classList.add("is-admin"),s.style.setProperty("display","inline-flex","important")):(s.classList.remove("is-admin"),s.style.setProperty("display","none","important")));const n=document.getElementById("topbar-btn-publish");n&&n.style.setProperty("display",i?"inline-flex":"none","important");const o=document.getElementById("mobile-drawer-publish-container");o&&o.style.setProperty("display",i?"block":"none","important");const r=document.getElementById("nav-btn-publish");r&&(i?(r.classList.add("is-admin"),r.style.setProperty("display","inline-flex","important")):(r.classList.remove("is-admin"),r.style.setProperty("display","none","important")));const d=document.getElementById("footer-publish-item");if(d&&d.style.setProperty("display",i?"block":"none","important"),e){if(a&&(a.innerHTML=`
        ...
        `;const b=t.querySelector("#btn-header-admin-panel");b&&b.addEventListener("click",()=>{this.onAdminClickCallback&&this.onAdminClickCallback()});const m=t.querySelector("#btn-header-signout");m&&m.addEventListener("click",async()=>{await w.signOut()})}}else{if(a){a.innerHTML=`
        ...
        `;const b=a.querySelector("#btn-topbar-signin");b&&b.addEventListener("click",k=>{k.preventDefault(),this.onAuthClickCallback&&this.onAuthClickCallback("signin")});const m=a.querySelector("#btn-topbar-signup");m&&m.addEventListener("click",k=>{k.preventDefault(),this.onAuthClickCallback&&this.onAuthClickCallback("signup")})}if(t){t.innerHTML=`
        ...
        `;const b=t.querySelector("#btn-header-signin");b&&b.addEventListener("click",()=>{this.onAuthClickCallback&&this.onAuthClickCallback("signin")});const m=t.querySelector("#btn-header-signup");m&&m.addEventListener("click",()=>{this.onAuthClickCallback&&this.onAuthClickCallback("signup")})}}const c=document.getElementById("mobile-drawer-auth");c&&(e?(c.innerHTML=`
        ...
        `,i&&((g=c.querySelector("#btn-drawer-write"))==null||g.addEventListener("click",()=>{var m;(m=document.getElementById("mobile-nav-drawer"))==null||m.classList.remove("open");const b=document.getElementById("mobile-drawer-overlay");b&&(b.style.display="none"),document.body.style.overflow="",this.onPublishClickCallback&&this.onPublishClickCallback()}),(y=c.querySelector("#btn-drawer-admin"))==null||y.addEventListener("click",()=>{var m;(m=document.getElementById("mobile-nav-drawer"))==null||m.classList.remove("open");const b=document.getElementById("mobile-drawer-overlay");b&&(b.style.display="none"),document.body.style.overflow="",this.onAdminClickCallback&&this.onAdminClickCallback()})),(E=c.querySelector("#btn-drawer-signout"))==null||E.addEventListener("click",async()=>{var m;(m=document.getElementById("mobile-nav-drawer"))==null||m.classList.remove("open");const b=document.getElementById("mobile-drawer-overlay");b&&(b.style.display="none"),document.body.style.overflow="",await w.signOut()})):(c.innerHTML=`
        ...
        `,(u=c.querySelector("#btn-drawer-signin"))==null||u.addEventListener("click",()=>{var m;(m=document.getElementById("mobile-nav-drawer"))==null||m.classList.remove("open");const b=document.getElementById("mobile-drawer-overlay");b&&(b.style.display="none"),document.body.style.overflow="",this.onAuthClickCallback&&this.onAuthClickCallback("signin")}),(h=c.querySelector("#btn-drawer-signup"))==null||h.addEventListener("click",()=>{var m;(m=document.getElementById("mobile-nav-drawer"))==null||m.classList.remove("open");const b=document.getElementById("mobile-drawer-overlay");b&&(b.style.display="none"),document.body.style.overflow="",this.onAuthClickCallback&&this.onAuthClickCallback("signup")})))}attachEventListeners(){const e=document.getElementById("btn-header-refresh");e&&e.addEventListener("click",()=>{e.classList.add("spinning"),this.resetCountdown(),this.onRefreshCallback&&this.onRefreshCallback(!1).finally(()=>{setTimeout(()=>e.classList.remove("spinning"),600)})});const t=document.getElementById("select-refresh-interval");t&&(t.value=p.getRefreshInterval().toString(),t.addEventListener("change",c=>{const u=parseInt(c.target.value,10);p.setRefreshInterval(u),this.startCountdown(),this.onIntervalChangeCallback&&this.onIntervalChangeCallback(u)}));const a=document.getElementById("global-search-input"),s=document.getElementById("mobile-search-input"),i=document.getElementById("mobile-search-clear");if(a){let c=null;a.addEventListener("input",u=>{const h=u.target.value;s&&s.value!==h&&(s.value=h,i&&(i.style.display=h?"inline-flex":"none")),clearTimeout(c),c=setTimeout(()=>{this.onSearchCallback&&this.onSearchCallback(h.trim())},250)}),window.addEventListener("keydown",u=>{u.key==="/"&&document.activeElement!==a&&document.activeElement!==s&&(u.preventDefault(),window.innerWidth<=900&&s?s.focus():a.focus())})}if(s){let c=null;s.addEventListener("input",u=>{const h=u.target.value;i&&(i.style.display=h.length>0?"inline-flex":"none"),a&&a.value!==h&&(a.value=h),clearTimeout(c),c=setTimeout(()=>{this.onSearchCallback&&this.onSearchCallback(h.trim())},250)}),i&&i.addEventListener("click",()=>{s.value="",i.style.display="none",a&&(a.value=""),this.onSearchCallback&&this.onSearchCallback("")})}const n=document.getElementById("btn-brand-home");n&&n.addEventListener("click",()=>{a&&(a.value=""),s&&(s.value=""),i&&(i.style.display="none"),this.onSearchCallback&&this.onSearchCallback("");const c=document.querySelector('.cat-tab[data-category="all"]');c&&c.click()});const o=document.getElementById("btn-open-publish-modal");o&&o.addEventListener("click",()=>{this.onPublishClickCallback&&this.onPublishClickCallback()});const r=document.getElementById("topbar-btn-publish");r&&r.addEventListener("click",c=>{c.preventDefault(),this.onPublishClickCallback&&this.onPublishClickCallback()});const d=document.getElementById("btn-theme-toggle");d&&d.addEventListener("click",()=>{this.onThemeToggleCallback&&this.onThemeToggleCallback()})}}class le{constructor(e){this.onArticleClickCallback=e,this.articles=[]}render(e){this.articles=e||[];const t=document.getElementById("breaking-news-ticker-container");if(!t)return;if(this.articles.length===0){t.style.display="none";return}t.style.display="block";const a=this.articles.slice(0,10),i=[...a,...a].map((o,r)=>`
    ...
    `,t.querySelectorAll(".ticker-item").forEach(o=>{o.addEventListener("click",()=>{const r=o.getAttribute("data-id"),d=this.articles.find(c=>c.id===r)||this.articles[0];this.onArticleClickCallback&&d&&this.onArticleClickCallback(d)})})}}class ce{constructor(e,t){this.onArticleClickCallback=e,this.onBookmarkToggleCallback=t,this.viewMode=p.getViewMode()}setViewMode(e){this.viewMode=e,p.setViewMode(e)}formatTimeAgo(e){try{const t=new Date(e),s=new Date-t,i=Math.floor(s/(1e3*60));if(i<1)return"Just now";if(i<60)return`${i}m ago`;const n=Math.floor(i/60);return n<24?`${n}h ago`:`${Math.floor(n/24)}d ago`}catch{return"Recently"}}render(e,t={}){const a=document.getElementById("main-news-feed");if(!a)return;const{category:s="all",searchQuery:i="",sourceFilter:n="all"}=t;if(!e||e.length===0){const y=t.category==="saved";if(t.category===l.PUBLISHED){a.innerHTML=`
        ...
        `;return}a.innerHTML=y?`<div class="empty-state-premium">
          ...
          </div>`;return}if(s===l.ALL&&!i&&n==="all"){this.renderHomeAllNews(e,a);return}const o=!i&&e.length>0,r=o?e[0]:null,d=o?e.slice(1):e,c=r?this.buildHeroCardHtml(r):"",u=this.buildArticlesGridHtml(d),h=s===l.BUSINESS&&!i?this.buildMarketIndicesDashboardHtml():"";let g="Latest Stories";i?g=`Search Results: "${i}"`:s===l.INDIA_POLITICS?g="🏛️ Indian Politics & National Governance":s===l.INDIA?g="🇮🇳 Indian Media Wires":s===l.WORLD?g="🌍 Global News Wires & International":s===l.BUSINESS?g="📊 Global & Indian Business Wire":s===l.GOOGLE_NEWS?g="🌐 Google News Live Wire":s===l.SAVED?g="🔖 Saved Bookmarks":s===l.PUBLISHED?g="✍️ Community & Published Articles":g=`${s.toUpperCase()} Wire`,a.innerHTML=`
      ${h}
    ...
    `}renderHomeAllNews(e,t){const a=e[0],s=e.slice(1,5),i=e.filter(u=>u.region==="india"||u.category===l.INDIA||u.category===l.INDIA_POLITICS),n=e.filter(u=>u.region==="global"||u.category===l.WORLD||u.category===l.GOOGLE_NEWS),o=e.filter(u=>u.category===l.BUSINESS),r=e.filter(u=>u.category===l.TECH||u.category===l.SCIENCE),d=e.slice(5,13),c=a.region==="india"?"NEW DELHI —":a.region==="global"?"GLOBAL WIRE —":"DISPATCH —";t.innerHTML=`
        ...
        <div class="hindu-lead-col" data-id="${a.id}">
          ...
          <div class="hindu-lead-footer">
            ...
            <div style="display: flex; gap: 8px;">
              <button class="btn-card-action ${p.isBookmarked(a.id,a.link)?"bookmarked":""}" data-action="bookmark" title="Bookmark">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="${p.isBookmarked(a.id,a.link)?"currentColor":"none"}" stroke="currentColor" stroke-width="2">
                  <path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"></path>
                </svg>
              </button>
            </div>
      ...
      `:""}
    `,this.attachCardEventListeners(e)}buildHeroCardHtml(e,t="LIVE LEAD STORY"){const a=p.isBookmarked(e.id,e.link),s=e.region==="india"||e.isPolitics;return`
    ...
    `}buildArticlesGridHtml(e){return this.viewMode==="grid"?`
        <div class="news-grid-cards">
          ${e.map(t=>{const a=p.isBookmarked(t.id,t.link);return`
      ...
      `}attachCardEventListeners(e){const t=document.getElementById("main-news-feed");t&&t.addEventListener("click",a=>{const s=a.target.closest("[data-action]"),i=a.target.closest("[data-id]");if(!i)return;const n=i.getAttribute("data-id"),o=e.find(r=>r.id===n);if(o)if(s){const r=s.getAttribute("data-action");if(r==="open-article")this.onArticleClickCallback&&this.onArticleClickCallback(o);else if(r==="bookmark"){const d=p.toggleBookmark(o);s.classList.toggle("bookmarked",d);const c=s.querySelector("svg");c&&c.setAttribute("fill",d?"currentColor":"none"),this.onBookmarkToggleCallback&&this.onBookmarkToggleCallback(o,d)}else r==="speak-article"?P.speakArticle(o):r==="share"&&(navigator.share?navigator.share({title:o.title,text:o.snippet,url:o.link||window.location.href}).catch(()=>{}):(navigator.clipboard.writeText(o.link||window.location.href),alert("Article link copied to clipboard!")))}else a.target.closest("button")||this.onArticleClickCallback&&this.onArticleClickCallback(o)})}}class de{constructor(){this.activeTopic="all",this.currentAffairsList=[...K]}render(){const e=document.getElementById("main-news-feed");if(!e)return;const t=this.activeTopic==="all"?this.currentAffairsList:this.currentAffairsList.filter(i=>i.category===this.activeTopic),s=new Date().toLocaleDateString("en-US",{weekday:"long",month:"long",day:"numeric",year:"numeric"});e.innerHTML=`
...
• Why: ${o.why}
• Impact: ${o.impact}
• Stakeholders: ${o.who}`;navigator.clipboard.writeText(r),i.innerHTML='<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#10b981" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg> Copied!',setTimeout(()=>{i.innerHTML='<svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg> Copy Briefing'},2e3)}})}),document.querySelectorAll(".quiz-option-btn").forEach(i=>{i.addEventListener("click",()=>{const n=i.getAttribute("data-ca-id"),o=parseInt(i.getAttribute("data-opt-idx"),10),r=this.currentAffairsList.find(c=>c.id===n),d=document.getElementById(`quiz-ans-${n}`);r&&d&&(d.classList.add("show"),o===r.quiz.correct?(i.style.borderColor="#10b981",i.style.background="rgba(16, 185, 129, 0.2)",i.style.color="#34d399"):(i.style.borderColor="#ef4444",i.style.background="rgba(239, 68, 68, 0.2)",i.style.color="#f87171"))})})}}class ue{constructor(e){this.onBookmarkToggleCallback=e,this.currentArticle=null,this.fontSize=17,this.init()}init(){this.renderModalContainer(),this.attachGlobalListeners()}renderModalContainer(){let e=document.getElementById("article-reader-modal");e||(e=document.createElement("div"),e.id="article-reader-modal",e.className="modal-overlay",document.body.appendChild(e))}open(e){this.currentArticle=e,this.previousTitle=document.title,e.title&&(document.title=`${e.title} — WHAT'S GOING ON`),p.markAsRead(e.id);const t=document.getElementById("article-reader-modal");if(!t)return;const a=p.isBookmarked(e.id,e.link),i=(e.content||e.snippet||"").split(`
...
`).filter(r=>r.trim().length>0);t.innerHTML=`
    ...
    `,document.body.appendChild(t),this.modalEl=t}attachEventListeners(){if(!this.modalEl)return;const e=this.modalEl.querySelector("#btn-close-publish-modal"),t=this.modalEl.querySelector("#btn-cancel-publish");e&&e.addEventListener("click",()=>this.close()),t&&t.addEventListener("click",()=>this.close()),this.modalEl.addEventListener("click",r=>{r.target===this.modalEl&&this.close()}),window.addEventListener("keydown",r=>{r.key==="Escape"&&this.isOpen&&this.close()});const a=this.modalEl.querySelectorAll(".preset-photo-btn"),s=this.modalEl.querySelector("#pub-custom-image-url"),i=this.modalEl.querySelector("#pub-image-preview"),n=this.modalEl.querySelector("#pub-preview-tag");a.forEach(r=>{r.addEventListener("click",()=>{a.forEach(c=>c.classList.remove("active")),r.classList.add("active");const d=r.getAttribute("data-url");this.selectedImageUrl=d,s&&(s.value=d),i&&(i.src=d),n&&(n.textContent="Preset Photo"),this.lastSelectedFile=null,this.currentPreviewBlobUrl&&(URL.revokeObjectURL(this.currentPreviewBlobUrl),this.currentPreviewBlobUrl=null),this.resetDropzoneDefault(),this.clearDropzoneError()})}),s&&s.addEventListener("input",()=>{a.forEach(r=>r.classList.remove("active")),this.selectedImageUrl=s.value.trim(),i&&(i.src=this.selectedImageUrl),n&&(n.textContent="Custom URL"),this.lastSelectedFile=null,this.currentPreviewBlobUrl&&(URL.revokeObjectURL(this.currentPreviewBlobUrl),this.currentPreviewBlobUrl=null),this.resetDropzoneDefault(),this.clearDropzoneError()}),this.setupDropzone();const o=this.modalEl.querySelector("#publish-studio-form");o&&o.addEventListener("submit",r=>{r.preventDefault(),this.handleSubmit()})}setupDropzone(){const e=this.modalEl.querySelector("#pub-dropzone"),t=this.modalEl.querySelector("#pub-file-input"),a=this.modalEl.querySelector("#pub-upload-retry-btn");!e||!t||(e.addEventListener("click",s=>{this.isUploadingImage||s.target.closest("#pub-upload-retry-btn")||t.click()}),e.addEventListener("keydown",s=>{(s.key==="Enter"||s.key===" ")&&!this.isUploadingImage&&(s.preventDefault(),t.click())}),t.addEventListener("change",()=>{t.files&&t.files.length>0&&this.handleFileSelected(t.files[0])}),this.dragCounter=0,e.addEventListener("dragenter",s=>{if(s.preventDefault(),s.stopPropagation(),this.dragCounter++,!this.isUploadingImage){e.classList.add("is-dragover");const i=this.modalEl.querySelector("#pub-dropzone-prompt");i&&(i.textContent="Drop image here to upload, or ")}}),e.addEventListener("dragover",s=>{s.preventDefault(),s.stopPropagation(),this.isUploadingImage||e.classList.add("is-dragover")}),e.addEventListener("dragleave",s=>{if(s.preventDefault(),s.stopPropagation(),this.dragCounter--,this.dragCounter<=0){this.dragCounter=0,e.classList.remove("is-dragover");const i=this.modalEl.querySelector("#pub-dropzone-prompt");i&&(i.textContent="Drag & drop photojournalist image here, or ")}}),e.addEventListener("drop",s=>{s.preventDefault(),s.stopPropagation(),this.dragCounter=0,e.classList.remove("is-dragover");const i=this.modalEl.querySelector("#pub-dropzone-prompt");if(i&&(i.textContent="Drag & drop photojournalist image here, or "),this.isUploadingImage)return;const n=s.dataTransfer;n&&n.files&&n.files.length>0&&this.handleFileSelected(n.files[0])}),a&&a.addEventListener("click",s=>{s.stopPropagation(),this.lastSelectedFile&&this.uploadFileToFirebase(this.lastSelectedFile)}))}handleFileSelected(e){if(!e)return;this.clearDropzoneError();const t=[".jpg",".jpeg",".png",".webp"],a=["image/jpeg","image/png","image/webp"],s="."+(e.name.split(".").pop()||"").toLowerCase(),i=(e.type||"").toLowerCase();if(!(a.includes(i)||t.includes(s))){this.showDropzoneError(`Invalid file type "${s||e.type}". Only .jpg, .jpeg, .png, and .webp images are allowed.`,!1);return}const o=5*1024*1024;if(e.size>o){const u=(e.size/1048576).toFixed(2);this.showDropzoneError(`File size exceeds 5MB limit (${u} MB). Please choose a smaller image.`,!1);return}this.lastSelectedFile=e,this.modalEl.querySelectorAll(".preset-photo-btn").forEach(u=>u.classList.remove("active")),this.currentPreviewBlobUrl&&URL.revokeObjectURL(this.currentPreviewBlobUrl),this.currentPreviewBlobUrl=URL.createObjectURL(e);const d=this.modalEl.querySelector("#pub-image-preview");d&&(d.src=this.currentPreviewBlobUrl);const c=this.modalEl.querySelector("#pub-preview-tag");c&&(c.textContent="Local Preview (Uploading...)"),this.uploadFileToFirebase(e)}async uploadFileToFirebase(e){this.isUploadingImage=!0,this.clearDropzoneError(),this.setDropzoneUploadingState(e,0);const t=this.modalEl.querySelector("#btn-submit-publish"),a=t?t.innerHTML:"";t&&(t.disabled=!0,t.style.opacity="0.6",t.style.cursor="not-allowed",t.innerHTML=`
        <div class="publish-dropzone-spinner" style="border-top-color:#fff; border-color:rgba(255,255,255,0.3);"></div>
        <span>Uploading Photo...</span>
      `);try{const s=await w.uploadArticleImage(e,r=>{this.setDropzoneUploadingState(e,r)});this.isUploadingImage=!1,this.selectedImageUrl=s;const i=this.modalEl.querySelector("#pub-custom-image-url");i&&(i.value=s);const n=this.modalEl.querySelector("#pub-image-preview");n&&(n.src=s);const o=this.modalEl.querySelector("#pub-preview-tag");o&&(o.textContent="Firebase Cloud Storage"),this.setDropzoneSuccessState(e)}catch(s){console.error("[PublishModal] Upload error:",s),this.isUploadingImage=!1,this.resetDropzoneDefault();let i="Upload failed. Please check connection and retry.";s.code==="storage/unauthorized"?i="Upload rejected by Firebase Storage rules. Ensure write access is granted for article-images/.":s.code==="storage/quota-exceeded"?i="Firebase Storage quota exceeded.":s.message&&(i=`Upload failed: ${s.message}`),this.showDropzoneError(i,!0);const n=this.modalEl.querySelector("#pub-preview-tag");n&&(n.textContent="Local Preview (Upload Failed)")}finally{t&&(t.disabled=!1,t.style.opacity="",t.style.cursor="",t.innerHTML=a)}}setDropzoneUploadingState(e,t){const a=this.modalEl.querySelector("#pub-dropzone-content"),s=this.modalEl.querySelector("#pub-dropzone-uploading"),i=this.modalEl.querySelector("#pub-dropzone-success"),n=this.modalEl.querySelector("#pub-upload-progress-fill"),o=this.modalEl.querySelector("#pub-upload-progress-text"),r=this.modalEl.querySelector("#pub-upload-filename");if(a&&(a.style.display="none"),i&&(i.style.display="none"),s&&(s.style.display="flex"),n&&(n.style.width=`${t}%`),o&&(o.textContent=`Uploading to Firebase Storage... ${t}%`),r){const d=(e.size/1048576).toFixed(2);r.textContent=`${e.name} (${d} MB)`}}setDropzoneSuccessState(e){const t=this.modalEl.querySelector("#pub-dropzone-content"),a=this.modalEl.querySelector("#pub-dropzone-uploading"),s=this.modalEl.querySelector("#pub-dropzone-success"),i=this.modalEl.querySelector("#pub-success-filename");if(t&&(t.style.display="none"),a&&(a.style.display="none"),s&&(s.style.display="flex"),i){const n=(e.size/1048576).toFixed(2);i.textContent=`✓ Uploaded: ${e.name} (${n} MB)`}}resetDropzoneDefault(){const e=this.modalEl.querySelector("#pub-dropzone-content"),t=this.modalEl.querySelector("#pub-dropzone-uploading"),a=this.modalEl.querySelector("#pub-dropzone-success"),s=this.modalEl.querySelector("#pub-file-input"),i=this.modalEl.querySelector("#pub-dropzone");e&&(e.style.display="flex"),t&&(t.style.display="none"),a&&(a.style.display="none"),s&&(s.value=""),i&&i.classList.remove("is-dragover"),this.dragCounter=0}showDropzoneError(e,t=!1){const a=this.modalEl.querySelector("#pub-upload-error"),s=this.modalEl.querySelector("#pub-upload-error-text"),i=this.modalEl.querySelector("#pub-upload-retry-btn");s&&(s.textContent=e),i&&(i.style.display=t?"inline-block":"none"),a&&(a.style.display="flex")}clearDropzoneError(){const e=this.modalEl.querySelector("#pub-upload-error"),t=this.modalEl.querySelector("#pub-upload-retry-btn");e&&(e.style.display="none"),t&&(t.style.display="none")}open(e=null){if(!w.isAdmin()){alert("Access Restricted: Only the administrator can write and publish articles. Please sign in with admin credentials.");return}this.modalEl||this.injectModalHtml();const t=w.getCurrentUser(),a=this.modalEl.querySelector("#pub-byline");if(a&&!e&&(t?a.value=t.displayName||t.email.split("@")[0]:a.value="What's Going On Editorial Desk"),this.isOpen=!0,this.modalEl.classList.add("active"),this.modalEl.setAttribute("aria-hidden","false"),document.body.style.overflow="hidden",this.resetDropzoneDefault(),this.clearDropzoneError(),this.lastSelectedFile=null,e){this.editingArticleId=e.id,this.modalEl.querySelector("#pub-headline").value=e.title||"",this.modalEl.querySelector("#pub-byline").value=e.source||"",this.modalEl.querySelector("#pub-category").value=e.category||l.INDIA_POLITICS,this.modalEl.querySelector("#pub-excerpt").value=e.snippet||"",this.modalEl.querySelector("#pub-content").value=e.content||"",this.modalEl.querySelector("#pub-custom-image-url").value=e.image||"",this.modalEl.querySelector("#pub-image-preview").src=e.image||"",this.selectedImageUrl=e.image||this.presetImages[0].url;const s=this.modalEl.querySelector("#pub-preview-tag");s&&(s.textContent="Existing Article Photo"),e.keyPoints&&(this.modalEl.querySelector("#pub-keypoints").value=e.keyPoints.join(`
`))}else{this.editingArticleId=null,this.selectedImageUrl=this.presetImages[0].url;const s=this.modalEl.querySelector("#pub-custom-image-url");s&&(s.value=this.presetImages[0].url);const i=this.modalEl.querySelector("#pub-image-preview");i&&(i.src=this.presetImages[0].url);const n=this.modalEl.querySelector("#pub-preview-tag");n&&(n.textContent="Preset Photo"),this.modalEl.querySelectorAll(".preset-photo-btn").forEach((r,d)=>r.classList.toggle("active",d===0))}}close(){this.modalEl&&(this.isOpen=!1,this.modalEl.classList.remove("active"),this.modalEl.setAttribute("aria-hidden","true"),document.body.style.overflow="",this.currentPreviewBlobUrl&&(URL.revokeObjectURL(this.currentPreviewBlobUrl),this.currentPreviewBlobUrl=null),this.resetDropzoneDefault(),this.clearDropzoneError())}handleSubmit(){if(!w.isAdmin()){alert("Access Restricted: Only the administrator can write and publish articles.");return}if(this.isUploadingImage){alert("Please wait for the photojournalist image upload to finish before publishing.");return}const e=this.modalEl.querySelector("#pub-headline").value.trim(),t=this.modalEl.querySelector("#pub-byline").value.trim()||"What's Going On Editorial",a=this.modalEl.querySelector("#pub-dateline").value,s=this.modalEl.querySelector("#pub-category").value,i=this.modalEl.querySelector("#pub-readtime").value.trim()||"3 min read",n=this.selectedImageUrl||this.presetImages[0].url,o=this.modalEl.querySelector("#pub-excerpt").value.trim(),r=this.modalEl.querySelector("#pub-content").value.trim(),d=this.modalEl.querySelector("#pub-keypoints").value.trim(),c=d?d.split(`
`).map(h=>h.trim()).filter(Boolean):["Comprehensive on-the-ground intelligence and editorial assessment.","Analysis corroborated by verified primary sources and statutory records.","Implications reviewed by What's Going On editorial desk."],u={id:this.editingArticleId||"user-art-"+Date.now(),title:e,source:t,sourceId:"user-published",category:s,region:s===l.WORLD?"global":"india",isPolitics:s===l.INDIA_POLITICS||s===l.INDIA,isUserPublished:!0,link:"#user-story-"+Date.now(),image:n,pubDate:new Date().toISOString(),snippet:`${a} ${o}`,content:r,keyPoints:c,readTime:i};p.saveCustomArticle(u),this.currentPreviewBlobUrl&&(URL.revokeObjectURL(this.currentPreviewBlobUrl),this.currentPreviewBlobUrl=null),this.close(),this.modalEl.querySelector("#publish-studio-form").reset(),this.onArticlePublishedCallback&&this.onArticlePublishedCallback(u)}}class pe{constructor(e){this.onAuthSuccessCallback=e,this.modalEl=null,this.isOpen=!1,this.currentTab="signin"}init(){this.injectModalHtml(),this.attachEventListeners()}injectModalHtml(){const e=document.getElementById("auth-modal-overlay");e&&e.remove();const t=document.createElement("div");t.id="auth-modal-overlay",t.className="auth-modal-overlay",t.setAttribute("role","dialog"),t.setAttribute("aria-modal","true"),t.setAttribute("aria-hidden","true"),t.innerHTML=`
    ...
    `;const s=e.querySelector("#admin-search-articles");s&&s.addEventListener("input",i=>{const n=i.target.value.toLowerCase().trim();e.querySelectorAll("#admin-articles-tbody tr").forEach(r=>{const d=r.textContent.toLowerCase();r.style.display=d.includes(n)?"":"none"})}),e.querySelectorAll(".btn-admin-delete").forEach(i=>{i.addEventListener("click",n=>{const o=n.target.getAttribute("data-del-id");confirm("Admin Action: Unpublish this story from What's Going On?")&&(p.deleteCustomArticle(o),this.switchTab("articles"),this.onArticleUpdatedCallback&&this.onArticleUpdatedCallback())})})}renderAlertsTab(e){const t=w.getBreakingAlert();e.innerHTML=`
    ...
    `}renderUsersTab(e){const t=w.getAllUsers(),a=p.getCustomArticles(),s=p.getBookmarks();e.innerHTML=`
    ...
    `}}class ge{constructor(){this.articles=[],this.currentCategory=l.ALL,this.searchQuery="",this.selectedSource="all",this.isLoading=!1,this.header=null,this.ticker=null,this.newsGrid=null,this.currentAffairs=null,this.modal=null,this.publishModal=null,this.authModal=null,this.adminPanel=null}async init(){this.applyTheme(p.getTheme()),this.initComponents(),this.renderCategoryNavigation();const e=window.location.hash.replace("#","");e&&Object.values(l).includes(e)&&(this.currentCategory=e,document.querySelectorAll(".cat-tab").forEach(a=>{a.classList.toggle("active",a.getAttribute("data-category")===e)})),await this.fetchNews(!1),this.initBackToTop()}applyTheme(e){document.documentElement.setAttribute("data-theme",e),p.setTheme(e);const t=document.getElementById("theme-icon-sun");t&&(e==="light"?t.innerHTML='<path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path>':t.innerHTML=`
          <circle cx="12" cy="12" r="5"></circle>
          <line x1="12" y1="1" x2="12" y2="3"></line><line x1="12" y1="21" x2="12" y2="23"></line>
          <line x1="4.22" y1="4.22" x2="5.64" y2="5.64"></line><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"></line>
          <line x1="1" y1="12" x2="3" y2="12"></line><line x1="21" y1="12" x2="23" y2="12"></line>
          <line x1="4.22" y1="19.78" x2="5.64" y2="18.36"></line><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"></line>
        `)}toggleTheme(){const t=p.getTheme()==="dark"?"light":"dark";this.applyTheme(t)}initComponents(){this.authModal=new pe(i=>{this.showToast(`✨ Welcome to What's Going On, ${i.displayName||i.email}!`,"success")}),this.authModal.init(),this.adminPanel=new me(()=>{this.renderActiveView(),this.showToast("Article moderation updated.","info")},i=>{this.handleBreakingAlert(i)}),this.adminPanel.init(),this.publishModal=new he(i=>{this.articles=[i,...this.articles.filter(n=>n.id!==i.id)],this.ticker.render(this.articles),this.renderActiveView(),window.scrollTo({top:0,behavior:"smooth"}),this.showToast("🎉 Your article has been published live to What's Going On!","success")}),this.publishModal.init(),this.header=new re(i=>this.fetchNews(i),i=>this.handleSearch(i),()=>this.toggleTheme(),i=>this.handleIntervalChange(i),()=>this.publishModal.open(),i=>this.authModal.open(i),()=>this.adminPanel.open(this.articles)),this.header.init(),w.onAuthStateChanged(i=>{this.header.updateUserAuthState(i);const n=w.isAdmin(),o=document.getElementById("nav-btn-publish");o&&(o.style.display=n?"inline-flex":"none");const r=document.getElementById("footer-publish-item");r&&(r.style.display=n?"block":"none")});const e=w.getBreakingAlert();e&&this.handleBreakingAlert(e),this.modal=new ue((i,n)=>{this.header.updateBookmarkBadge()}),this.ticker=new le(i=>{this.modal.open(i)}),this.newsGrid=new ce(i=>this.modal.open(i),(i,n)=>{this.header.updateBookmarkBadge(),this.currentCategory===l.SAVED&&this.renderActiveView()}),this.currentAffairs=new de;const t=document.getElementById("btn-bookmarks-view");t&&t.addEventListener("click",()=>{this.setCategory(l.SAVED)});const a=document.getElementById("btn-view-grid"),s=document.getElementById("btn-view-list");a&&s&&(a.addEventListener("click",()=>{a.classList.add("active"),s.classList.remove("active"),this.newsGrid.setViewMode("grid"),this.renderActiveView()}),s.addEventListener("click",()=>{s.classList.add("active"),a.classList.remove("active"),this.newsGrid.setViewMode("compact"),this.renderActiveView()}))}renderCategoryNavigation(){const e=document.getElementById("category-tabs-nav"),t=document.getElementById("select-source-filter"),a=[{id:l.ALL,label:"⚡ All News (Front Page)"},{id:l.INDIA_POLITICS,label:"🏛️ Indian Politics & Governance"},{id:l.INDIA,label:"🇮🇳 India Media Wires"},{id:l.WORLD,label:"🌍 Global News Wires"},{id:l.BUSINESS,label:"📊 Market Indices & Economy"},{id:l.GOOGLE_NEWS,label:"🌐 Google News"},{id:l.CURRENT_AFFAIRS,label:"⭐ Current Affairs Hub",highlight:!0},{id:l.TECH,label:"🤖 Tech & AI"},{id:l.SCIENCE,label:"🚀 Science & Defense"},{id:l.PUBLISHED,label:"✍️ Community & Published"},{id:l.SAVED,label:"🔖 Saved Stories"}];if(e){const s=a.map(o=>`
      ...
      `;e.innerHTML=s+n,e.addEventListener("click",o=>{if(o.target.closest("#nav-btn-publish")){this.publishModal.open();return}const d=o.target.closest(".cat-tab");if(d){const c=d.getAttribute("data-category");this.setCategory(c)}})}t&&(t.innerHTML=`
    ...
    `,document.body.prepend(a);const s=a.querySelector("#btn-close-alert-banner");s&&s.addEventListener("click",()=>a.remove())}async fetchNews(e=!1){if(this.isLoading)return;this.isLoading=!0;const t=document.getElementById("btn-header-refresh");t&&t.classList.add("spinning"),e||this.renderLoadingSkeleton();try{const a=await H.fetchAllFeeds();if(this.articles=a,p.setCachedArticles(this.articles),this.ticker.render(this.articles),this.renderActiveView(),H.enrichArticlesWithImages(this.articles,s=>{document.querySelectorAll(`[data-id="${s.id}"] img`).forEach(o=>{o.src=s.image});const n=document.querySelector(`.hindu-lead-col[data-id="${s.id}"]`);if(n){const o=n.querySelector(".hindu-lead-img");o&&(o.src=s.image)}p.setCachedArticles(this.articles)}),this.header&&this.header.updateLastSyncTime(new Date),e){const s=new Date().toLocaleTimeString("en-IN",{hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!0});this.showToast(`🔄 Auto-refreshed: ${this.articles.length} news stories synchronized at ${s}`,"success")}}catch(a){console.error("Error fetching feeds:",a),this.showToast("Notice: Using synchronized offline intelligence feeds.","info")}finally{this.isLoading=!1,t&&setTimeout(()=>t.classList.remove("spinning"),700)}}renderLoadingSkeleton(){const e=document.getElementById("main-news-feed");e&&(e.innerHTML=`
